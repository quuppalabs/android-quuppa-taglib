...
public enum IntentAction {
	QT_SYSTEM_ERROR, QT_SYSTEM_EVENT, QT_SCHEDULE_NOT_ENABLED, QT_BLE_NOT_ENABLED, QT_MOVING, QT_STATIONARY, QT_STARTED, QT_STOPPED, QT_STATIONARY_CHECK, QT_RESTART, QT_ACTIVE_ONLY_CHANGED;
